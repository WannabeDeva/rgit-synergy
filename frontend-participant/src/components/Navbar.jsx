...
const ParticipantNavbar = () => {
  return (
    <nav className="flex items-center justify-between bg-white shadow-md px-6 py-4">
      {/* HackHub Logo */}
      <Button asChild variant="link" className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link to="/profile" className="text-gray-600 hover:text-blue-600 text-lg font-medium">
          Profile
        </Link>
      </div>
    </nav>
