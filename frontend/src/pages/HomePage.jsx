            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <span className="text-blue-700 font-medium">Medical Emergency Response System</span>
                </motion.div>
...
>
  ...
  <span className="block text-gray-700 text-3xl md:text-4xl lg:text-5xl mt-4">
    Emergency Assistance When Seconds Count
  </span>
</motion.h1>
                ...
                >
                  Get instant access to emergency medical services, hospital locators, and AI-powered symptom analysis for critical situations.
                </motion.p>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Designed with emergency situations in mind, our tools provide critical support when you need it most
            </motion.p>
